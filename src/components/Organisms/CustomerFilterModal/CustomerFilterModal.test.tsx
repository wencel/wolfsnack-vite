...
describe('CustomerFilterModal', () => {
  ...
  it('updates form fields when parent values change', () => {
    const { testRerender } = testRender(<CustomerFilterModal {...defaultProps} />);
  ...
  it('resets form fields when modal is reopened', () => {
    ...
    const { testRerender } = testRender(<CustomerFilterModal {...propsWithValues} />);
    ...
    // Close modal
    testRerender(<CustomerFilterModal {...propsWithValues} showModal={false} />);
